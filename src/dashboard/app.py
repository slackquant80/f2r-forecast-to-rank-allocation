...
.health,.metrics,.boundary{display:grid;gap:.65rem}.health{grid-template-columns:repeat(6,minmax(0,1fr));margin:.85rem 0 1.15rem}.metrics{grid-template-columns:repeat(6,minmax(0,1fr));margin:.8rem 0 1rem}.boundary{grid-template-columns:repeat(4,minmax(0,1fr));margin:.8rem 0}.cell,.metric,.bcell{background:#0f1821;border:1px solid #22313d;border-radius:10px;padding:.85rem .92rem}.hl,.ml,.bl{font-size:.58rem;letter-spacing:.1em;color:#6d7b87;text-transform:uppercase;font-weight:800}.hv,.bv{font-size:.98rem;color:#eef3f6;font-weight:750;margin-top:.28rem}.hs,.ms,.bs{font-size:.64rem;color:#697784;margin-top:.2rem;line-height:1.45}.mv{font-size:1.35rem;color:#eef3f6;font-weight:800;margin-top:.35rem}
...
off_holding=off.get("holding_month") or mtd.get("holding_month") or "—"
...
with tabs[0]:
    ...
    <div class="step"><div class="step-n">05</div><div class="step-t">Governed performance</div><div class="step-d">Completed history stops at the last closed holding month; Current MTD remains separate.</div></div>
